...
- (void)setPageControlMarginBottom:(CGFloat)offset{
...
- (void)layoutSubviews
{
    ...
    CGFloat y = self.mainView.sd_height - size.height - marginOffset;
...
//            NSString *key = [[SDWebImageManager sharedManager] cacheKeyForURL:[NSURL URLWithString:imagePath]];
//            UIImage *lastPreviousCachedImage = [[SDImageCache sharedImageCache] imageFromDiskCacheForKey:key];
            
            [cell.imageView sd_setImageWithPreviousCachedImageWithURL:[NSURL URLWithString:imagePath] placeholderImage:nil options:SDWebImageRetryFailed progress:nil completed:^(UIImage *image, NSError *error, SDImageCacheType cacheType, NSURL *imageURL) {
